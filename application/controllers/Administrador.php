            ...
            if (isset($_FILES["file"]["name"])) {
                ...
                foreach ($object->getWorksheetIterator() as $worksheet) {
                    ...
                    for ($row = 2; $row <= $highestRow; $row++) {
                        ...
                        $edad = $worksheet->getCellByColumnAndRow(2, $row)->getValue();
                        $cargo = $worksheet->getCellByColumnAndRow(3, $row)->getValue();
                        $empresa = $worksheet->getCellByColumnAndRow(4, $row)->getValue();
