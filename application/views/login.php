            ...
            if (password != "") {
                $.ajax({
                    ...
                    if (msg.msg == "usuario") {
                        ...
                        setTimeout(() => {
                            location.href = "panel_usuario";
                        }, 2000);
                    } else if (msg.msg == "inactivo") {
                        toastr.error("El usuario se encuentra bloqueado, comunicarse con el Administrador a cargo.");
                    } else if (msg.msg == "error" || msg.msg == "nada") {
                        toastr.error("El usuario no existe o la clave es incorrecta.");
                    } else if (msg.msg == "finalizado") {
                        toastr.error("El usuario ya completo su tiempo limite.");
                    }else if (msg.msg == "final") {
                        toastr.error("El usuario ya completo los cuestionarios.");
                    }
                });
            } else {
                $("#clave").focus();
